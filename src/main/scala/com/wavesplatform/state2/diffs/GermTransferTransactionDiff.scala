...
import scorex.transaction.assets.GermTransferTransaction

import scala.util.Right

object GermTransferTransactionDiff {
  def apply(state: SnapshotStateReader, s: FunctionalitySettings, blockTime: Long, height: Int)(tx: GermTransferTransaction): Either[ValidationError, Diff] = {
